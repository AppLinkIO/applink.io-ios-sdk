...
s.license          = { :type => 'Commercial', :file => 'AppLinkIO-iOS-1.1.4/LICENSE' }
s.author           = { 'AppLink.io, Inc.' => 'support@applink.io' }
s.source           = { :http => 'https://sdk.applink.io/iOS/AppLinkIO-iOS-1.1.4.zip' }
s.platform          = :ios
s.ios.deployment_target = '8.0'
s.source_files = 'AppLinkIO-iOS-1.1.4/*.h'
s.public_header_files = 'AppLinkIO-iOS-1.1.4/*.h'
s.ios.vendored_libraries = 'AppLinkIO-iOS-1.1.4/libAppLinkIO.a'
