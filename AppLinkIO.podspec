...
s.license          = { :type => 'Commercial', :file => 'AppLinkIO-iOS-2.2.0/LICENSE' }
s.author           = { 'AppLink.io, Inc.' => 'support@applink.io' }
s.source           = { :http => 'https://sdk.applink.io/iOS/AppLinkIO-iOS-2.2.0.zip' }
s.platform          = :ios
s.ios.deployment_target = '8.0'
s.source_files = 'AppLinkIO-iOS-2.2.0/*.h'
s.public_header_files = 'AppLinkIO-iOS-2.2.0/*.h'
s.ios.vendored_libraries = 'AppLinkIO-iOS-2.2.0/libAppLinkIO.a'
