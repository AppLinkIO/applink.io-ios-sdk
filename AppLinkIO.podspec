...
s.license          = { :type => 'Commercial', :file => 'AppLinkIO-iOS-2.9.2/LICENSE' }
s.author           = { 'AppLink.io, Inc.' => 'support@applink.io' }
s.source           = { :http => 'https://cdn.applink.io/sdk/ios/AppLinkIO-iOS-2.9.2.zip' }
s.platform          = :ios
s.ios.deployment_target = '8.0'
s.source_files = 'AppLinkIO-iOS-2.9.2/*.h'
s.public_header_files = 'AppLinkIO-iOS-2.9.2/*.h'
s.ios.vendored_libraries = 'AppLinkIO-iOS-2.9.2/libAppLinkIO.a'
